...
from svnowrag.schemas import ChatSchema
from svnowrag.connectors import ServiceNowConnector
...
class Agent:
    ...
    def _config_service(self, url, user, password) -> None:
        self.connector = ServiceNowConnector(url, user, password)
